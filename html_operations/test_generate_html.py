...
from database_fetch import *  # Assuming the function is in this file

"""Only need to test the logic to extract fields"""
"""Some test cases are redundant as they can never occur based on use-case (ex, having no fields)"""
